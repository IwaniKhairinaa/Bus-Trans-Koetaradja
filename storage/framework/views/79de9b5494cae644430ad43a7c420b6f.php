    ...
    <div class="container-fluid bg-image" style="background-image: url('<?php echo e(asset('img/bg-image.png')); ?>')">
        <div class="relative-content">
            ...
            <form action="<?php echo e(route('register.process')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="nama" value="<?php echo e($data_diri['nama']); ?>">
                <input type="hidden" name="ttl" value="<?php echo e($data_diri['ttl']); ?>">
                <input type="hidden" name="alamat" value="<?php echo e($data_diri['alamat']); ?>">
                <input type="hidden" name="email" value="<?php echo e($data_diri['email']); ?>">
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel-bus-trans-koetaradja\resources\views/signup-next.blade.php ENDPATH**/ ?>