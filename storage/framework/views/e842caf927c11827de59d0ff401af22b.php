    ...
    <div class="container-fluid bg-image" style="background-image: url('<?php echo e(asset('img/bg-image.png')); ?>')">
        <div class="sidebar">
            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a class="poppins-<?php echo e($data_bus_selected->id == $bus->id ? 'bold' : ''); ?>"
                    href="<?php echo e(route('services.jadwal-bus.detail', ['jadwalBus' => $bus->id])); ?>">
        ...
        <div class="relative-content">
            <div class="scroll">
                <?php if(isAdmin()): ?>
                    <div class="action">
                        <button data-koridor-id="<?php echo e($data_bus_selected->id); ?>" class="btn-hapus-koridor btn-sm btn-danger"
                            type="button" data-toggle="modal" data-target="#hapusModalKoridor">Hapus Data Koridor</button>
                        <button data-koridor-id="<?php echo e($data_bus_selected->id); ?>"
                            data-nama-koridor="<?php echo e($data_bus_selected->nama_koridor); ?>"
                            data-nama-rute="<?php echo e($data_bus_selected->nama_rute); ?>"
                ...
                <?php endif; ?>
                <?php $__currentLoopData = $data_tujuan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tujuan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="jadwal-bus">
                        <div class="jadwal-bus-header">
                            <img src="<?php echo e(asset('img/bus.png')); ?>" alt="">
                            <h1><?php echo e($tujuan->nama_tujuan); ?></h1>
                            <?php if(isAdmin()): ?>
                                <i data-tujuan-id="<?php echo e($tujuan->id); ?>" data-toggle="modal" data-target="#editModal"
                                    class="btn-edit-tujuan fas fa-edit"></i>
                                <i data-tujuan-id="<?php echo e($tujuan->id); ?>" class="btn-hapus-tujuan fas fa-trash"
                                    data-toggle="modal" data-target="#hapusModal"></i>
                            <?php endif; ?>
                        </div>
                        <div class="jadwal-bus-body">
                            <?php $__currentLoopData = $tujuan->keberangkatan_bus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keberangkatan_bus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="jadwal-bus-item">
                                    <span><?php echo e("{$keberangkatan_bus->waktu_keberangkatan}, {$keberangkatan_bus->nama_bus}"); ?></span>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('services.jadwal-bus.tujuan-bus.add')); ?>" method="POST">
                    <input type="hidden" name="jadwal_bus_id" value="<?php echo e($data_bus_selected->id); ?>">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.second', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel-bus-trans-koetaradja\resources\views/jadwal-bus-detail.blade.php ENDPATH**/ ?>