...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid bg-image" style="background-image: url('<?php echo e(asset('img/bg-image.png')); ?>')">
        <div class="relative-content">
            ...
            <div class="services">
                <a href="<?php echo e(route('services.jadwal-bus')); ?>" class="service-item">
                    <img src="<?php echo e(asset('img/Ellipse 1.png')); ?>" alt="">
                    <h1 class="poppins-bold">Jadwal Bus</h1>
                    <p>Cek jadwal dan rute bus sesuai kebutuhan mu</p>
                </a>
                <a href="<?php echo e(route('services.titik-halte')); ?>" class="service-item">
                    <img src="<?php echo e(asset('img/Ellipse 2.png')); ?>" alt="">
...
<?php echo $__env->make('layouts.second', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel-bus-trans-koetaradja\resources\views/services.blade.php ENDPATH**/ ?>