    ...
    <div class="container-fluid bg-image" style="background-image: url('<?php echo e(asset('img/bg-image.png')); ?>')">
        <div class="relative-content">
            ...
            <div class="bottom">
                ...
                <p>Belum punya akun? <a href="<?php echo e(route('register.show')); ?>" class="text-decoration-none poppins-bold">Buat
                        Akun</a></p>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel-bus-trans-koetaradja\resources\views/signin.blade.php ENDPATH**/ ?>