    ...
    <div class="content">
        <header>
            ...
            <div class="header-right">
                <img src="<?php echo e(asset('img/Rectangle 16.png')); ?>" alt="">
            </div>
        </header>
        ...
        <div class="contact-us">
            <div class="contact-us-item">
                <div class="logo">
                    <img src="<?php echo e(asset('img/Rectangle 20.png')); ?>" alt="">
                </div>
            ...
            <div class="contact-us-item">
                <div class="logo">
                    <img src="<?php echo e(asset('img/Rectangle 21.png')); ?>" alt="">
                </div>
                <h1 class="poppins-semibold">Hubungi Kami</h1>
                <p>Jika dalam perjalanan anda merasa terganggu silahkan huungi nomor dibawah ini.</p>
        ...
        <div class="form-saran">
            <div class="logo-saran">
                <img src="<?php echo e(asset('img/Group 15.png')); ?>" alt="">
            </div>
...
<?php echo $__env->make('layouts.second', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel-bus-trans-koetaradja\resources\views/contact.blade.php ENDPATH**/ ?>